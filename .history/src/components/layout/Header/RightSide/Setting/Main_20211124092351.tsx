  ...
  return (
    <Container>
      <Header>
        ...
        <HeaderRight>
          <h4>Ham Tru Van Lorem ipsum dolor sit, amet consectetur adipisicing elit. Illo facilis repellendus quis reprehenderit omnis quos laborum animi a, maiores nisi mollitia provident perferendis officia eos culpa, vitae, recusandae assumenda aperiam!</h4>
