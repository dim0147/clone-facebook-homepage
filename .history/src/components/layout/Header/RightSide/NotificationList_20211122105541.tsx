  ...
  const notificationList: NotificationRowProps[] = [
    {
      ...
      content:
        '<strong>Roman Reign</strong> is live now: "Dont miss a third of the action on the Survivor Series Kickoff as Sh...".',
    ...
    },
    {
      avatar: RomanReignsImg,
      content:
        '<strong>Roman Reign</strong> is live now: "Dont miss a first of the action on the Survivor Series Kickoff as Sh...".',
      //   content: 'Lorem ipsum, dolor wd wa dwa awdawd  dd awihu adwhui whadui dw kaw koaio awmdi',
      isRead: false,
      time: '25 minutes ago',
      type: 'live',
